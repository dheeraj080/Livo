        ...
        <form onSubmit={handleUpdate} className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative">
                <User className="absolute left-3 top-3 text-muted-foreground/50" size={18} />
                <Input
                className="pl-10"
                value={name}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
                <Mail className="absolute left-3 top-3 text-muted-foreground/50" size={18} />
                <Input
                className="pl-10"
                type="email"
                value={email}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
                <Key className="absolute left-3 top-3 text-muted-foreground/50" size={18} />
                <Input
                className="pl-10"
                type="password"
                value={password}
